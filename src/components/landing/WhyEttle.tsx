            ...
            <div data-why-compare className="mt-10 grid gap-6 md:grid-cols-2">
                <div className="card">
                    ...
                    <ul className="mt-2 space-y-1 text-sm text-[var(--color-muted)]">
                        <li>• Dynamic plans that evolve with your data</li>
                        <li>• Clear explanations for each exercise</li>
                        <li>• Gamification (XP, leaderboards, rewards)</li>
                    </ul>
                </div>
                <div className="card">
                    <h3 className="font-semibold">Traditional Personal Trainer</h3>
                    <ul className="mt-2 space-y-1 text-sm text-[var(--color-muted)]">
                        <li>• High cost per session</li>
                        <li>• Hard to maintain scheduling consistency</li>
                        <li>• Dependence on the professional</li>
                    </ul>
                </div>
            </div>
